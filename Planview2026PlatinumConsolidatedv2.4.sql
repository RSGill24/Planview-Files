...
-- Source Views      : FDXMIG.ip.FDXPROD_initiatives_extract
--                     FDXMIG.ip.FDXPROD_epics_extract
--                     FDXMIG.ip.FDXPROD_tasks_extract
...
BEGIN
    ...
    -- Source      : FDXMIG.ip.FDXPROD_initiatives_extract
    ...
    SELECT
        ...
        -- [Execution Type] not in ip.FDXPROD_initiatives_extract — excluded
        ...
        -- are NOT in FDXMIG.ip.FDXPROD_initiatives_extract view.
    ...
    FROM FDXMIG.ip.FDXPROD_initiatives_extract;
    ...
    -- Source      : FDXMIG.ip.FDXPROD_epics_extract
    ...
    SELECT
        ...
        -- FDXMIG.ip.FDXPROD_epics_extract — date casts applied to available cols
    ...
    INTO #epic_stage
    FROM FDXMIG.ip.FDXPROD_epics_extract;
    ...
    -- Source      : FDXMIG.ip.FDXPROD_tasks_extract
    ...
    FROM FDXMIG.ip.FDXPROD_tasks_extract;
