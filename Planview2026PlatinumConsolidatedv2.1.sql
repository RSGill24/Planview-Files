...
BEGIN
    ...
    PRINT '  dbo.stg_prod_init : ' + CAST((SELECT COUNT(*) FROM dbo.stg_prod_init) AS VARCHAR) + ' rows';
    PRINT '  dbo.stg_prod_epic : ' + CAST((SELECT COUNT(*) FROM dbo.stg_prod_epic) AS VARCHAR) + ' rows';
    PRINT '  dbo.stg_prod_task : ' + CAST((SELECT COUNT(*) FROM dbo.stg_prod_task) AS VARCHAR) + ' rows';
    PRINT CONVERT(VARCHAR, GETDATE(), 120);
    PRINT '======================================================';
