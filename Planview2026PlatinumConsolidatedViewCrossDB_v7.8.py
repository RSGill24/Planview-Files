...
def merge_sp1_into_output(conn, ts, df_init_sp1, df_epic_sp1):
    ...
    # Only merge SP1-specific mapped columns — do NOT merge all columns
    # Merging all columns causes conflicts with SP2 columns already in output
    init_to_merge = [c for c in df_init_sp1.columns if c in sp1_init_mapped]
    ...
    # Only merge SP1-specific mapped columns
    epic_to_merge = [c for c in df_epic_sp1.columns if c in sp1_epic_mapped]
